...
const translations = {
  en: {
    ...
    contact: {
      ...
      description: 'Have a question or want to learn more? Feel free to contact us during business hours.',
      visitUs: 'Visit Us',
      location: 'Location',
      hours: 'Hours',
      businessHours: 'Business Hours',
      ...
      closed: 'Closed',
      walkIns: 'Walk-ins Welcome',
      walkInsDesc: 'No appointment necessary. Just drop by during our business hours.',
    },
    footer: {
    ...
    contact: {
      title: 'Ota Yhteyttä',
      subtitle: 'Ole yhteydessä meihin',
      getInTouch: 'Ota Yhteyttä',
      reachOut: 'Ota Meihin Yhteyttä',
      description: 'Onko sinulla kysyttävää tai haluatko tietää lisää? Ota rohkeasti yhteyttä aukioloaikojen aikana.',
      ...
      closed: 'Suljettu',
      walkIns: 'Walk-in Asiakkaat Tervetulleita',
      walkInsDesc: 'Ei tarvetta ajanvaraukseen. Tule vain käymään aukioloaikojen aikana.',
    },
    footer: {
