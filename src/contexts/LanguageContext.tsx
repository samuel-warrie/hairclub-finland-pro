...
const translations = {
  en: {
    ...
    footer: {
      tagline: 'Where traditional craftsmanship meets contemporary style. Experience the art of grooming in the heart of Oulu.',
    ...
    gallery: {
      ...
      followJourney: 'Seuraa Matkaammee',
    ...
    footer: {
      tagline: 'Perinteinen käsityötaito kohtaa modernin tyylin. Koe parturitaiteen taidetta Oulun sydämessä.',
