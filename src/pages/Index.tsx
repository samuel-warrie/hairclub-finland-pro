        ...
        <div className="relative z-10 text-center px-5 sm:px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="font-heading font-semibold tracking-tight leading-[0.9] flex flex-col items-center gap-0 text-brand-gold">
              ...
              <span className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-light tracking-[0.3em] uppercase">
                PARTURI•KAMPAAMO
              </span>
              <span className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-light tracking-widest uppercase">
                EST. 2012
              </span>
            </h1>
          ...
          <div className="relative overflow-hidden">
            ...
            >
              {[...galleryPreview, ...galleryPreview].map((image, index) => (
                <div
                  key={`${image.id}-${index}`}
                  className="group relative w-[200px] sm:w-[240px] md:w-[280px] aspect-[4/5] overflow-hidden flex-shrink-0"
                >
                  <img
                    src={image.src}
                    alt={image.alt}
