      ...
      <div className="container-custom section-padding-sm">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-1 space-y-4 sm:space-y-6">
            <h3 className="font-heading text-xl sm:text-2xl font-bold tracking-tight bg-clip-text text-transparent" style={{ background: 'linear-gradient(180deg, #d4b5a0 0%, #c9a68b 50%, #b8957a 100%)' }}>
              HAIR CLUB FINLAND
            </h3>
