export const servicesTranslations = {
  en: {
    ...
    services: {
      ...
      'Salon hair cut for women': 'Salon hair cut for women',
    ...
    services: {
      ...
      'Salon hair cut for women': 'Naisten hiustenleikkaus',
      'Single Color': 'Yhdellä värillä',
      'Multi-Color Highlights': 'Monivärjäys',
      'Color Removal': 'Värinpoisto',
      'Highlights': 'Raidat',
      'Hair Coloring': 'Miesten hiustenvärjäys',
